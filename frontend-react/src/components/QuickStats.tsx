...
const QuickStats = ({
  ...
  return (
    <div className="relative flex flex-col justify-between rounded-2xl bg-white dark:bg-surface-dark p-6 shadow-sm ring-1 ring-gray-900/5 dark:ring-white/10">
