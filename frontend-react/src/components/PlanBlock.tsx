...
const PlanBlock = ({ plan }: PlanBlockProps) => {
  ...
  return (
    <div className="relative flex flex-col justify-between overflow-hidden rounded-xl bg-white dark:bg-card-dark p-5 shadow-sm ring-1 ring-gray-900/5 transition-all hover:ring-primary/50 dark:ring-white/10 dark:hover:ring-primary/50">
